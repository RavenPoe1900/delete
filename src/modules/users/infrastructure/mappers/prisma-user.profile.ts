  ...
  override get profile() {
    return (mapper: Mapper) => {
      ...
      createMap<UserPrismaPayload, UserResponseDto>(
        ...
        forMember(
          (d) => d.tripsAsShipper,
          mapWith(TripSummaryDto, 'Trip', (s) => s.tripsAsShipper),
        ),
        forMember(
          (d) => d.tripsAsCarrier,
          mapWith(TripSummaryDto, 'Trip', (s) => s.tripsAsCarrier),
        ),

        // vehicles
        forMember(
          (d) => d.vehicles,
          mapWith(VehicleSummaryDto, 'Vehicle', (s) => s.vehicles),
        ),
        ...
        forMember(
          (d) => d.ratingsGiven,
          mapWith(RatingDetailDto, 'Rating', (s) => s.ratingsGiven),
        ),
        forMember(
          (d) => d.ratingsReceived,
          mapWith(RatingDetailDto, 'Rating', (s) => s.ratingsReceived),
        ),
      );
    };
  }
